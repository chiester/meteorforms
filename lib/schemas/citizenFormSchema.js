...
contactSchema = new SimpleSchema({
    ...
    address: {
        label: "Address (please do not use real data)",
        type: addressSchema
    },
    phone: {
        type: String,
...
CitizenForms.attachSchema(new SimpleSchema({
    ...
    contact: {
        label: "Your Contact Information (this is a sample, so please do not use real names)",
        type: contactSchema
    },
    gRecaptchaResponse: {
        type: String,
    ...
    notifyMe: {
        type: String,
        optional: true,
        label: "Send an email notification of this form submission",
    ...
    notifyEmail: {
        ...
        regEx: SimpleSchema.RegEx.Email,
        max: 50,
        label: "Enter Email Address (will not be stored or displayed)"
    }
}));
